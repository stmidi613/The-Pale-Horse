    ...
    <Fragment>
      ...
      <div className="h-full w-full m-auto flex flex-col justify-center items-center">
        ...
        <h2 className="text-2xl pb-4 pt-10 text-crimson">New User</h2>
          <form className="m-2 w-48 md:w-96">
            ...
            <input
              ...
              className="mt-2 mb-10 border-2 border-crimson"
            />
            <br />
            <div className="flex justify-center">
              <input
                type="submit"
                className="w-32 bg-crimson hover:shadow-md text-pale-green py-2 px-4 rounded"
              />
            </div>
          </form>
        </div>
